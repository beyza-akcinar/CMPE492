...
def process_freesurfer_file(file, muayene):
    try:
        ...
        for _, row in df.iterrows():
            FreeSurferSonuc.objects.create(
                muayene=muayene,
...
def freesurfer_list_view(request):
    ...
    statistics = {}
    if request.method == "POST":
        # Assuming `freesurfer_sonuclari` is filtered according to `selected_tani`
        #numeric_attributes = ['brain_seg_vol']  # replace with actual numeric attribute names
        numeric_attributes = [
